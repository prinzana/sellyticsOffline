        ...
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button
              ...
              className="flex items-center justify-center gap-3 px-6 py-4 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 border-2 border-slate-300 dark:border-slate-600 rounded-2xl font-semibold transition-all shadow-lg text-slate-900 dark:text-white"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-3 px-6 py-4 bg-indigo-900 hover:from-indigo-700 hover:to-purple-700 text-white rounded-2xl font-semibold transition-all shadow-lg shadow-indigo-500/30"
            >
